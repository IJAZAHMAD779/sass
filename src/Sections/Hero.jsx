...
const Hero = () => {
  return (
    <section className="relative py-36 max-md:py-22">
      <Element name="hero">
        <div className="container">
          <div className="relative z-2 max-w-512 max-lg:max-w-388">
            ...
            <p className="max-w-440 mb-14 body-1 max-md:mb-10">
              We designed Lumina AI Video Editor to be an easy to use, quick to
              learn, and surprisingly powerful.
            </p>
            <LinkScroll to="features" offset={-100} spy smooth>
              <Button icon="/sass/images/zap.svg">Try it now</Button>
            </LinkScroll>
          </div>
